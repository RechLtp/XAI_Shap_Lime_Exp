...
test_images, test_labels = np.load('dataset/mnist_c/identity/test_images.npy'), np.load('dataset/mnist_c/identity/test_labels.npy')
...
model = keras.saving.load_model('Model/shap_model.h5')
